$(function () {
    ...
    (function (app) {
        ...
        app.imprimir = function () {
            ...
            $("#imprimirTipo").attr("action", locacion + "controlador/ruteador/imprimir.php");
            $("#imprimirTipo").submit();
        };
        ...
        app.validarGuardado = function () {
            var url = locacion + "controlador/ruteador/Ruteador.php?accion=agregar&formulario=TipoFactura";
        ...
        app.guardarTipoFactura = function () {
            var url;
            if ($("#id").val() == 0)
                url = locacion +"controlador/ruteador/Ruteador.php?accion=agregar&formulario=TipoFactura";
            else
                url = locacion +"controlador/ruteador/Ruteador.php?accion=modificar&formulario=TipoFactura";
        ...
        app.eliminarTipoFactura = function (id) {
            var url = locacion + "controlador/ruteador/Ruteador.php?accion=eliminar&formulario=TipoFactura";
