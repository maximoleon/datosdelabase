$(function () {
    ...
    (function (app) {
        ...
        app.buscarCliente = function () {
            ...
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=buscar&formulario=Cliente";
        ...
        app.selectTipo = function (tipoCargado) {
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=listar&formulario=TipoCliente";
            $.ajax({
                url: url,
                method: 'POST',
                dataType: 'json',
                success: function (datos) {
                    ...
                    $.each(datos, function (clave, tipo) {
                        console.log(tipo);
                        if (clave == 0)
                            $('#tipos').append('<option value=' + tipo.id_tipoCliente + ' >Selecciona un tipo</option>');
                        if (tipo.tipo_tipoCliente == tipoCargado)
                            $('#tipos').append('<option selected value=' + tipo.id_tipoCliente + ' >' + tipo.tipo_tipoCliente + '</option>');
                        else
                            $('#tipos').append('<option value=' + tipo.id_tipoCliente + ' >' + tipo.tipo_tipoCliente + '</option>');
                    });
                },
                error: function (datos) {
                    alert(datos.responseText);
        ...
        app.imprimir = function () {
            ...
            $("#imprimirCliente").attr("action", locacion+"controlador/ruteador/imprimir.php");
            $("#imprimirCliente").submit();
        };

        app.buscarClientes = function () {
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=listar&formulario=Cliente";
            $.ajax({
                url: url,
                method: 'POST',
                dataType: 'json',
        ...
        app.guardarCliente = function () {
            var url;
            if ($("#id").val() == 0)
                url = locacion+"controlador/ruteador/Ruteador.php?accion=agregar&formulario=Cliente";
            else
                url = locacion+"controlador/ruteador/Ruteador.php?accion=modificar&formulario=Cliente";
        ...
        app.eliminarCliente = function (id) {
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=eliminar&formulario=Cliente";
        ...
        app.selectProvincia = function (provinciaCargada) {
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=listar&formulario=Lugares";
            $.ajax({
                url: url,
                method: 'POST',
                dataType: 'json',
        ...
        app.selectDepartamento = function (provincia) {
            ...
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=listar&formulario=Lugares&lugar=departamento&provincia=" + provincia;
        ...
        app.selectLocalidad = function (departamento, localidadCargada) {
            ...
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=listar&formulario=Lugares&lugar=localidad&departamento=" + departamento;
