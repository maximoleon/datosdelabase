$(function() {
    ...
    (function(app) {
        ...
        app.validarGuardado = function(){
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=agregar&formulario=TipoCliente";
        ...
        app.guardarTipoCliente = function() {
            var url;
            if ($("#id").val() == 0)
                url = locacion + "controlador/ruteador/Ruteador.php?accion=agregar&formulario=TipoCliente";
            else
                url = locacion + "controlador/ruteador/Ruteador.php?accion=modificar&formulario=TipoCliente";
        ...
        app.eliminarTipoCliente = function(id) {
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=eliminar&formulario=TipoCliente";
