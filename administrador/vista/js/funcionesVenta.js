$(function () {
    ...
    (function (app) {
        ...
        app.guardarFactura = function () {
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=agregar&formulario=Factura";
            var cant = $(".cantidad");
            var cod = $(".codigo");
            ...
            var factura = {usuario: localStorage["usuario"], cuil: cuil, tipo: tipoFactura};
        ...
        app.validaciones = function (datos) {
            ...
            if (usuario == "" || isNaN(usuario) || usuario != localStorage["usuario"]) {
        ...
        app.autocompletarCliente = function () {
            var base = new Array();
            $.ajax({
                url: locacion+"controlador/ruteador/Ruteador.php?accion=listar&formulario=Cliente",
                method: 'POST',
                dataType: 'json',
        ...
        app.listarProductos = function () {
            productos = new Array();
            $.ajax({
                url: locacion+"controlador/ruteador/Ruteador.php?accion=listarD&formulario=Producto",
                method: 'POST',
                dataType: 'json',
                success: function (data) {
        ...
        app.comboTiposFacturas = function () {
            var url = locacion+"controlador/ruteador/Ruteador.php?accion=listar&formulario=TipoFactura";
            $.ajax({
                url: url,
                method: 'POST',
                dataType: 'json',
