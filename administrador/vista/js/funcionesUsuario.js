$(function () {
    ...
    (function (app) {
        ...
        app.buscar = function () {
            ...
            var url = locacion + "controlador/ruteador/Ruteador.php?accion=buscar&formulario=Usuario";
        ...
        app.imprimir = function () {
            ...
            $("#imprimirUsuario").attr("action", locacion + "controlador/ruteador/imprimir.php");
            $("#imprimirUsuario").submit();
        };

        app.guardarUsuario = function () {
            //alert("entre en agregar");
            var url = locacion + "controlador/ruteador/Ruteador.php?accion=agregar&formulario=Usuario";
        ...
        app.modificarUsuario = function () {
            ...
            var url = locacion + "controlador/ruteador/Ruteador.php?accion=modificar&formulario=Usuario";
            var datosEnviar = $("#formUsuario").serialize();
            $.ajax({
                url: url,
                method: 'POST',
        ...
        app.listarUsuarios = function () {
            ...
            var url = locacion + "controlador/ruteador/Ruteador.php?accion=listar&formulario=Usuario";
            $.ajax({
                url: url,
                method: 'POST',
                dataType: 'json',
        ...
        app.eliminarUsuario = function (id) {
            var url = locacion + "controlador/ruteador/Ruteador.php?accion=eliminar&formulario=Usuario";
        ...
        app.resetClaveUsuario = function (id) {
            var url = locacion + "controlador/ruteador/Ruteador.php?accion=reset&formulario=Usuario";
            var datosEnviar = {id: id};
            $.ajax({
                url: url,
                method: "POST",
